...
Emit a handoff matching the `HANDOFF_JSON` shape in `${CLAUDE_PLUGIN_ROOT}/templates/project-log.template.md`: open files, decisions, `[DEBT-xxx]` items, mission queue (`missions_queued`), and next mission recommendation.
